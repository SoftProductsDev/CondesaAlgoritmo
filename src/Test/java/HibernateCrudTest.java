...
/*public class HibernateCrudTest extends TestCase {
  ...
  public void testCreateCondeso(){
    ...
    condeso29.setContrato(otros);
    condeso29.setLunch(true);
    condeso29.setTarde(true);
    condeso29.setManana(true);
    condeso29.setColor("#f4df42");
    condeso29.setCaja(false);
    condeso29.setLevel(1);
    ...
    condeso30.setId(118);
    condeso30.setNombre("Max Rodriguez");
    condeso30.setAbreviacion("MR");
    condeso30.setMasculino(true);
    condeso30.setFemenino(false);
    condeso30.setContrato(otros);
    condeso30.setLunch(true);
    condeso30.setTarde(true);
    condeso30.setManana(true);
    condeso30.setColor("#e245e8");
    condeso30.setCaja(false);
    condeso30.setLevel(1);
    condeso30.setTipo(nuevo);
    ...
    condeso31.setId(119);
    condeso31.setNombre("Nicolas M");
    condeso31.setAbreviacion("NM");
    condeso31.setMasculino(true);
    condeso31.setFemenino(false);
    condeso31.setContrato(otros);
    condeso31.setLunch(true);
    condeso31.setTarde(true);
    condeso31.setManana(true);
    condeso31.setColor("#f441d6");
    condeso31.setCaja(false);
    condeso31.setLevel(1);
    condeso31.setTipo(nuevo);
    ...
    condeso32.setColor("#41f48e");
    condeso32.setCaja(false);
    condeso32.setLevel(1);
    condeso32.setTipo(nuevo);
